...
public class FileList implements java.io.Serializable {
    ...
    public synchronized void addFile(String owner, String group, String path, int keyVersion, byte[] IVarray) {
        ShareFile newFile = new ShareFile(owner, group, path, keyVersion, IVarray);
        list.add(newFile);
